...
@class FFTDecoder0x01;
@protocol FFTDecoder0x01Delegate <NSObject>
...
@interface FFTDecoder0x01 : NSObject

@property (nonatomic, assign) AVFormatContext *ic;
@property (nonatomic, assign) int streamIdx;
@property (nonatomic, copy) NSString * name;
@property (nonatomic, weak) id <FFTDecoder0x01Delegate> delegate;
