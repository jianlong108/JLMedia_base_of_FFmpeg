...
typedef enum MRPixelFormat{
    ...
    MR_PIX_FMT_RGB555,      // packed RGB 5:5:5, 16bpp, (msb)1X 5R 5G 5B(lsb), little-endian, X=unused/undefined
...
typedef enum MRPixelFormatMask{
    ...
    MR_PIX_FMT_MASK_RGB555  = 1 << MR_PIX_FMT_RGB555,     // packed RGB 5:5:5, 16bpp, (msb)1X 5R 5G 5B(lsb), little-endian, X=unused/undefined
