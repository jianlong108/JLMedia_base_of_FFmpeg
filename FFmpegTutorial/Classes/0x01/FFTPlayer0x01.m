...
@implementation FFTPlayer0x01

//中止线程的方法
static int decode_interrupt_cb(void *ctx)
{
    FFTPlayer0x01 *player = (__bridge FFTPlayer0x01 *)ctx;
...
- (void)performResultOnMainThread:(NSString *)info
{
    mr_sync_main_queue(^{
        ...
        [self.delegate player:self receiveMediaStream:info];
    });
}
